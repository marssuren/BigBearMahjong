...
namespace LuaFramework
{
	public class LuaBehaviour : Base
	{
		...
		//绑定Slider的ValueChange事件
		public void AddSliderValueChanged(GameObject _go, LuaFunction _luaFunction)
		{
			UISlider tSlider = _go.GetComponent<UISlider>();
			EventDelegate tEventDelegate = new EventDelegate(delegate ()
			{
				_luaFunction.Call(tSlider.value);
			});
